...
# Process directories
inflow_directory = "/home/james/Desktop/research/SSID/CrawlE_Proc_20000_defended/inflow/"
outflow_directory = "/home/james/Desktop/research/SSID/CrawlE_Proc_20000_defended/outflow/"
...
np.save('train_inflows_defended.npy', train_inflows)
np.save('val_inflows_defended.npy', val_inflows)
np.save('train_outflows_defended.npy', train_outflows)
np.save('val_outflows_defended.npy', val_outflows)
