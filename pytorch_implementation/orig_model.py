...
class DFModel(nn.Module):
    def __init__(self, input_shape=(4, 2000), emb_size=64):
        ...
        self.block1_pool = nn.MaxPool1d(8, stride=5, padding=2)
        ...
        self.block2_pool = nn.MaxPool1d(8, stride=5, padding=2)
        ...
        self.block3_pool = nn.MaxPool1d(8, stride=5, padding=2)
        ...
        self.block4_pool = nn.MaxPool1d(8, stride=5, padding=2)

        self.flatten = nn.Flatten()
        self.input_shape = input_shape

        self.dense = nn.Linear(768, emb_size)
